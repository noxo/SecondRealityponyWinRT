...
namespace SecondRealipony
{
    class Rarity : SRSegment
    {
        ...
        public override string MusicName { get { return "rarity"; } }

        public Rarity(Game game)
            : base(game)
        {
            rarity = game.Content.Load<Texture2D>("Rarity Glow");
            rarityOuter = game.Content.Load<Texture2D>("Rarity Glow Outer");
