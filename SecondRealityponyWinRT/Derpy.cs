...
namespace SecondRealipony
{
    class Derpy : SRSegment
    {
        ...
        public override string MusicName { get { return "derpy"; } }
        ...
        const int LATITUDES = 250;
        const int LONGITUDES = 250;
        ...
        public Derpy(Game game)
            : base(game)
        {
            transmission = game.Content.Load<Texture2D>("transmission");
            derpy = game.Content.Load<Texture2D>("derpy");
